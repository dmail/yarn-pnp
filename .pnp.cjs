...
function $$SETUP_STATE(hydrateRuntimeState, basePath) {
  return hydrateRuntimeState({
    ...
    "fallbackPool": [
      [
        "whatever",
        "file:./deps/whatever::locator=yarn-pnp-test%40workspace%3A."
      ]
    ],
    ...
    "packageRegistryData": [
      [null, [
        [null, {
          "packageLocation": "./",
          "packageDependencies": [
            ["whatever", "file:./deps/whatever::locator=yarn-pnp-test%40workspace%3A."]
          ],
          "linkType": "SOFT",
        }]
      ]],
      ["whatever", [
        ["file:./deps/whatever::locator=yarn-pnp-test%40workspace%3A.", {
          "packageLocation": "./.yarn/cache/whatever-file-3b8834512a-2.zip/node_modules/whatever/",
          "packageDependencies": [
            ["whatever", "file:./deps/whatever::locator=yarn-pnp-test%40workspace%3A."]
          ],
          "linkType": "HARD",
